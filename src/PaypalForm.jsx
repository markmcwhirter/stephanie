 ...
 export default function PaypalForm() {
   ...
   return (
    <form target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post">
      ...
      <input type="hidden" name="item_name" value=""></input>
      <input type="hidden" name="item_number" value=""></input>
      <input type="hidden" name="currency_code" value="GBP"></input>
      <input type="hidden" name="amount" id="amount_86e55eb7a4f3e6bd7eb54b739702384f" value=""></input>
      ...
      <input class="wpedon_paypalbuttonimage" type="image" src="https://www.paypalobjects.com/webstatic/en_US/btn/btn_donate_pp_142x27.png" border="0" name="submit" alt="Make your payments with PayPal. It is free, secure, effective." ></input>
